...
import mainBackground from './images/Food-Background.png';
import aboutBackground from './images/food-background2.png';
import menuBackground from './images/food-background3.png';
...
function switchTab(tab) {
  ...
  switch (tab) {
    case 'Home':
      loadHomePage();
      animateHero();
      setBackground(backgroundImages.Home);
      break;
    case 'Menu':
      loadMenuPage();
